...
ActiveRecord::Schema.define(version: 2021_06_09_071712) do
  ...
  create_table "buyers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "building_name_and_room_number", null: false
    t.string "product_purchase_management", null: false
  ...
  create_table "product_purchase_managements", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_product_purchase_managements_on_item_id"
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "first_name_full_width", default: "", null: false
    t.string "last_name_full_width", default: "", null: false
